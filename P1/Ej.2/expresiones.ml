ISO-8854-1 (configurar la consola con esto)
();; *-:unit = ()*
2+5*3;; *-:int = 17*
1.0;; *-:float = 1.0*
1.0 * 2;; *Error de compilacion de tipo*
2-2.0;; *Error de compilacion de tipo*
3.0+2.0;; *-:float=5.0*
5/3;; *-:int = 1*
5 mod 3;; *-:int = 2*
3.0 *. 2.0 ** 3.0;; *-:float = 24.0*
3.0 = float_of_int 3;; *-:bool true*
sqrt 4;; *Error de compilacion de tipo*
int_of_float 2.1 + int_of_float (-2.9);; *-:int = 0*
truncate 2.1 + truncate (-2.9);; *-:int = 0*
floor 2.1 +. floor (-2.9);; *-:int = -1*
ceil 2.1 +. ceil -2.9;; *Error de compilación de tipo*
2.0 ** 3.0 ** 2.0;; *-:float = 512.0*
'B';; *-:char = 'B'*
...
if 3=4 then 0 else "4";; *Error de compilación de tipo*
(if 3<5 then 8 else 10) + 4;; *-:int = 12*
2.0 *. asin 1.0;; *-:float = 3.14159265358979312*
sin(2.0 *. asin 1.0 /. 2.);; *-:floar = 1*
...
floor;; *-:floar -> float = <fun>*
Char.code;; *-:char -> int = <fun>*
Char.chr;; *-:int -> char = <fun>*
Char.uppercase;; *-:char -> char = <fun>*
Char.lowercase;; *-:char -> char = <fun>*
